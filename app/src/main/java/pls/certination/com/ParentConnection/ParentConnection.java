package pls.certination.com.ParentConnection;
...
public class ParentConnection extends AppCompatActivity
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_parent_connection);
        ...
        fab1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent facebookIntent=getOpenFacebookIntent(ParentConnection.this);
        ...
        fab2.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent googleIntent=getOpenLdIntent(ParentConnection.this);
        ...
        fab3.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent twitterIntent=getOpenTwitterIntent(ParentConnection.this);
