...
public class ViewCourses extends AppCompatActivity
    ...
    //    setSupportActionBar(toolbar);
        ...
        myFragmentTransaction.replace(R.id.containerViewtraining, new TrainingPageAdapter()).commit();
        ...
        fab1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent facebookIntent=getOpenFacebookIntent(ViewCourses.this);
        ...
        fab2.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent googleIntent=getOpenLdIntent(ViewCourses.this);
        ...
        fab3.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent twitterIntent=getOpenTwitterIntent(ViewCourses.this);
