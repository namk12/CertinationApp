...
public class GuestLecture extends AppCompatActivity
    ...
    Button guestlectureapply, guestlecturerequest;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        fab1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent facebookIntent=getOpenFacebookIntent(GuestLecture.this);
        ...
        fab2.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent googleIntent=getOpenLdIntent(GuestLecture.this);
        ...
        fab3.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent twitterIntent=getOpenTwitterIntent(GuestLecture.this);
        ...
        guestlectureapply=(Button)findViewById(R.id.guestlecturerequest);
        guestlectureapply.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent=new Intent(GuestLecture.this,GuestLectureApply.class);
                startActivity(intent);
            }
        });
        guestlecturerequest=(Button)findViewById(R.id.guestlectureregister);
        guestlecturerequest.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent=new Intent(GuestLecture.this,GuestLectureRegister.class);
                startActivity(intent);
            }
        });
