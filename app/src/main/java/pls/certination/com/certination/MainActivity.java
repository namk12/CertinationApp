...
import pls.certination.com.Pls.Login;
import pls.certination.com.certination.profile.Profile_first;
import pls.certination.com.certination.utilities.calculator.Calculator;
...
public class MainActivity extends AppCompatActivity
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        fab2.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent googleIntent=getOpenLdIntent(MainActivity.this);
        ...
        myFragmentTransaction.replace(R.id.containerView, new FragmentPageAdapter()).commit();
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        {
            Intent i=new Intent(this,Profile_first.class);
            startActivity(i);
        }
        if (id == R.id.nav_pls)
        {
        ...
        {
            Intent i=new Intent(this,pls.certination.com.Rms.rms.class);
            startActivity(i);
        }
        ...
        else if (id == R.id.nav_note_maker)
        {
            Intent i=new Intent(this,Note_maker.class);
            startActivity(i);
        }
