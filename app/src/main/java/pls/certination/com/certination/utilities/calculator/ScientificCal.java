package pls.certination.com.certination.utilities.calculator;
...
//
        ...
        e1.setOnTouchListener(otl);

        e2.setOnTouchListener(new View.OnTouchListener(){
            @Override
            public boolean onTouch(View v, MotionEvent event) {
                int inType = e2.getInputType(); // backup the input type
                e2.setInputType(InputType.TYPE_NULL); // disable soft input
                e2.onTouchEvent(event); // call native handler
                e2.setInputType(inType); // restore input type
...
//        int start =e2.getSelectionEnd();
        ...
        switch (v.getId()) {
            ...
            case R.id.num0:
                ...
                //e2.setText(e2.getText().insert(start , "0"));
                break;

            case R.id.num1:
                e2.setText(e2.getText() + "1");
                //e2.setText(e2.getText().insert(start, "1"));

                break;

            case R.id.num2:
                e2.setText(e2.getText() + "2");
                //e2.setText(e2.getText().insert(start, "2"));
                break;

            case R.id.num3:
                e2.setText(e2.getText() + "3");
                //e2.setText(e2.getText().insert(start, "3"));
                break;


            case R.id.num4:
                e2.setText(e2.getText() + "4");
                //e2.setText(e2.getText().insert(start, "4"));
                break;

            case R.id.num5:
                e2.setText(e2.getText() + "5");
                //e2.setText(e2.getText().insert(start, "5"));
                break;

            case R.id.num6:
                e2.setText(e2.getText() + "6");
                //e2.setText(e2.getText().insert(start, "6"));
                break;

            case R.id.num7:
                e2.setText(e2.getText() + "7");
                //e2.setText(e2.getText().insert(start, "7"));
                break;

            case R.id.num8:
                e2.setText(e2.getText() + "8");
                //e2.setText(e2.getText().insert(start, "8"));
                break;

            case R.id.num9:
                e2.setText(e2.getText() + "9");
                //e2.setText(e2.getText().insert(start, "9"));
                break;
            ...
            case R.id.dot:
                ...
                //e2.setText(e2.getText().insert(start, "."));
                count++;
            ...
            case R.id.log:
                    ...
                    text = e2.getText().toString();
                    if(toggleMode==2) {
                        e2.setSelection((e2.getText().length()-1));
                        e2.setText("ln(" + text + ")");
                    }
                    else
                        e2.setText("log(" + text + ")");
