package pls.certination.com.Internship;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        fab1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent facebookIntent=getOpenFacebookIntent(Internship.this);
        ...
        fab2.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent googleIntent=getOpenLdIntent(Internship.this);
        ...
        fab3.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent twitterIntent=getOpenTwitterIntent(Internship.this);
        ...
        ViewInternship=(Button)findViewById(R.id.view_internship);
        ViewInternship.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent i=new Intent(Internship.this,InternshipView.class);
                startActivity(i);
            }
        });
    }
